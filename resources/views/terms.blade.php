        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                                &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to localhost.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to localhost, accessible from <a
                                    href="http://127.0.0.1:8000/" rel="external nofollow noopener"
                    ...
                    <ul>
                        <li>By visiting this page on our website: <a href="http://127.0.0.1:8000/"
                                rel="external nofollow noopener" target="_blank">http://127.0.0.1:8000/</a></li>
                    </ul>
                </div>
            </div>
        </div>
